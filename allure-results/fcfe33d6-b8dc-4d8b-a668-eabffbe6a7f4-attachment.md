...
- application [ref=e1]:
      ...
      - generic [ref=e33]:
        ...
        - list [ref=e34]:
          ...
          - listitem [ref=e66]:
            ...
            - list
      - toolbar [ref=e71]:
        - generic [ref=e72]: 15/03/2026 17:56:02 |
  ...
  - dialog "คำสั่งคณะเกษตรศาสตร์และเทคโนโลยี" [active] [ref=e75]:
    - form [ref=e76]:
      - generic [ref=e77]: ระบบคำสั่งปฏิบัติงาน (ผู้ร่างคำสั่ง)
      - button "ร่างคำสั่งใหม่" [ref=e78] [cursor=pointer]:
        - generic [ref=e79]: ร่างคำสั่งใหม่
      - button "คำสั่งที่ดำเนินการแล้ว" [ref=e80] [cursor=pointer]:
        - generic [ref=e81]: คำสั่งที่ดำเนินการแล้ว
      - button "กล่องคำสั่ง" [ref=e82] [cursor=pointer]:
        - generic [ref=e83]: กล่องคำสั่ง
      - generic [ref=e84]:
        - text: "& U I ["
        - list [ref=e85]:
          - listitem [ref=e86]:
            - generic [ref=e88]:
              - generic [ref=e89]: "&"
              - generic [ref=e90] [cursor=pointer]: ร่างคำสั่งใหม่
              - text: 
            - list
          - listitem [ref=e91]:
            - generic [ref=e93]:
              - generic [ref=e94]: U
              - generic [ref=e95] [cursor=pointer]: กล่องคำสั่ง
              - text: 
            - list
          - listitem [ref=e96]:
            - generic [ref=e98]:
              - generic [ref=e99]: I
              - generic [ref=e100] [cursor=pointer]: คำสั่งที่ดำเนินการแล้ว
              - text: 
            - list
          - listitem [ref=e101]:
            - generic [ref=e103]:
              - generic [ref=e104]: "["
              - generic [ref=e105] [cursor=pointer]: กลับหน้าหลัก
              - text: 
            - list
      - textbox [ref=e106]
      - generic [ref=e107]: คำค้น
      - grid [ref=e108]:
        - rowgroup [ref=e109]:
          - row "รหัสคำสั่ง เรื่อง วันที่เริ่มต้น วันที่สิ้นสุด สถานะคำสั่ง" [ref=e110]:
            - columnheader [ref=e111]
            - columnheader "รหัสคำสั่ง" [ref=e112]
            - columnheader "เรื่อง" [ref=e113]
            - columnheader "วันที่เริ่มต้น" [ref=e114]
            - columnheader "วันที่สิ้นสุด" [ref=e115]
            - columnheader "สถานะคำสั่ง" [ref=e116]
        - rowgroup [ref=e117]
        - group [ref=e118]:
          - button [disabled]
          - button [disabled]
          - separator [ref=e119]
          - generic [ref=e120]: Page
          - spinbutton [disabled]: "0"
          - generic [ref=e121]: of 0
          - separator [ref=e122]
          - button [disabled]
          - button [disabled]
          - separator [ref=e123]
